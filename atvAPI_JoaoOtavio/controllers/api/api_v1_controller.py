...
def api_detalhe_oferta(oferta_id):
    ...
    if not oferta:
        return jsonify({"erro": "Oferta não encontrada"}), 404 #TODO QUAL ERRO APARECE QUANDO NÃO ENCONTRA A OFERTA? FEITO!
    return jsonify({
        "id": oferta.id,
...
@api_v1_bp.route("/ofertas", methods=["POST"]) #TODO Qual é a rota? FEITO!
