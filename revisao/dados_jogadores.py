...
def popular_dados():
    ...
    jogadores = [
        ...
        Jogador(nome="Gabriel Magalhães", posicao="Defensor", clube="Arsenal", cabeceio=9, forca=10),
        Jogador(nome="Ibañez", posicao="Defensor", clube="Al-Ahli", cabeceio=8, forca=8),
        Jogador(nome="Léo Pereira", posicao="Defensor", clube="Flamengo", cabeceio=8, forca=6),
        ...
        Jogador(nome="Casemiro", posicao="Meio-campista", clube="Inter Miami", cabeceio=10, forca=8),
        ...
        # Atacantes
        Jogador(nome="Endrick", posicao="Atacante", clube="Real Madrid", cabeceio=7, forca=8),
